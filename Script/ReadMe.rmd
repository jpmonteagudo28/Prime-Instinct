...
The data for this repo was scraped from the [Prime Glossay](https://t5k.org/glossary/) site. The .txt file contains information on Charmichael numbers or probable primes (PRP) up to 500 for based 2 through 20 (binary through vigesimal).


```{r echo=FALSE}
setwd(C:/Users/jpmonteagudo/Desktop/R/Prime-Instinct)
